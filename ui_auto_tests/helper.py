...
class BaseMethods:
    """містить базові методи для взаємодії з веб-елементами"""
    ...
    def set_data(self, locator_type: str, locator: str, data: str or int) -> str or int:
        self.wait_for_visibility_of_el(locator_type, locator).send_keys(data)
        return data
